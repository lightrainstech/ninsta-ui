    ...
    <>
      ...
      <div className="container mt-32 ">
        <div className="prose prose-lg dark:prose-invert prose-slate max-w-none">
          ...
          <p>
            {`Ninsta follows a standard procedure of using log files. These files
          ...
          <p>
            {`Like any other website, Ninsta uses 'cookies'. These cookies are
          ...
          <p>
            ...
            advertising partners of Ninsta.
          </p>

          <p>
            {`Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Ninsta, which are
          ...
          <p>
            Note that Ninsta has no access to or control over these cookies that
          ...
          <p>
            {`Ninsta's Privacy Policy does not apply to other advertisers or
          ...
          <p>
            Ninsta does not knowingly collect any Personal Identifiable
          ...
          <p>
            ...
            that they shared and/or collect in Ninsta. This policy is not
